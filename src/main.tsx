...
function App() {
  ...
  return (
    <>
      ...
      >
        <svg className="whatsappIcon" viewBox="0 0 32 32" role="img" aria-hidden="true">
          <path d="M16.04 3.2c-7.02 0-12.72 5.63-12.72 12.58 0 2.22.59 4.39 1.71 6.3L3.2 28.8l6.93-1.79a12.85 12.85 0 0 0 5.9 1.44h.01c7.02 0 12.73-5.63 12.73-12.58S23.06 3.2 16.04 3.2Zm0 22.98h-.01c-1.9 0-3.76-.51-5.38-1.48l-.39-.23-4.11 1.06 1.1-3.94-.26-.4a10.19 10.19 0 0 1-1.58-5.41c0-5.69 4.67-10.32 10.42-10.32 2.79 0 5.41 1.08 7.38 3.04a10.19 10.19 0 0 1 3.05 7.3c0 5.69-4.67 10.38-10.42 10.38Zm5.71-7.74c-.31-.15-1.84-.9-2.13-1-.29-.11-.5-.15-.71.15-.21.31-.82 1-.99 1.21-.18.2-.36.23-.67.08-.31-.15-1.31-.48-2.5-1.53-.93-.82-1.55-1.83-1.73-2.14-.18-.31-.02-.48.13-.63.14-.14.31-.36.47-.54.15-.18.21-.31.31-.51.1-.2.05-.38-.03-.54-.08-.15-.71-1.69-.97-2.32-.26-.61-.52-.53-.71-.54h-.61c-.21 0-.54.08-.82.38-.29.31-1.08 1.05-1.08 2.55 0 1.51 1.11 2.96 1.26 3.16.15.2 2.18 3.3 5.28 4.62.74.32 1.31.51 1.76.65.74.23 1.41.2 1.94.12.59-.09 1.84-.74 2.1-1.46.26-.72.26-1.33.18-1.46-.08-.13-.28-.2-.59-.35Z" />
        </svg>
      </a>
      {isReviewPopupOpen ? (
